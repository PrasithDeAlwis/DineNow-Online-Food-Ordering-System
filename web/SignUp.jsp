                ...
                <form class="mt-8 space-y-6" action="processSignUp.jsp" method="POST">
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <select id="role" name="role" required class="appearance-none rounded-lg relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-yellow-500 focus:border-yellow-500 focus:z-10 sm:text-sm">
